...
class CollectionStateAdapter(val context: Context, val data: ArrayList<CollectionStateModel>): BaseAdapter() {
    override fun getCount(): Int {
        return data.size
    }

    override fun getItem(position: Int): CollectionStateModel {
